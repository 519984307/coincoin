...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid coincoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid coincoin address" in e.error['message'])
