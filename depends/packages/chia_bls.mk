package=chia_bls
$(package)_version=v20220703
# It's actually from https://github.com/Chia-Network/bls-signatures, but we have so many patches atm that it's forked
$(package)_download_path=https://github.com/blazegeek/bls-signatures/releases/download/v20220703
$(package)_file_name=bls-signatures-main.tar.gz
$(package)_sha256_hash=d949ddb2f5a495d643b4129f9b20345fc27977401be4e53e76bcb553f449345e
