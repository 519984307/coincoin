# Linearize
Construct a linear, no-fork, best version of the CoinCoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install geekcash_hash

https://github.com/geekcash/geek_hash
...
JSON-RPC server. Running `coincoind` or `coincoin-qt -server` will be sufficient.
...
* `input`: coincoind blocks/ directory containing blkNNNNN.dat
