 ...
 */
const std::string CLIENT_NAME("BlazeGeekCash");
...
#define BUILD_DESC_WITH_RC(maj, min, rev, rc, build) \
    "v" DO_STRINGIZE(maj) "." DO_STRINGIZE(min) "." DO_STRINGIZE(rev) "-rc" DO_STRINGIZE(rc) "." DO_STRINGIZE(build)
