...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner CoinCoin address\n"
            "  payee          - Print the masternode payout CoinCoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting CoinCoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "coincoin",               "masternode",             &masternode,             true,  {} },
    { "coincoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "coincoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "coincoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "coincoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "coincoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
