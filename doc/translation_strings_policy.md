...
This document provides guidelines for internationalization of the CoinCoin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `coincoin_en.ts` remains unchanged.
